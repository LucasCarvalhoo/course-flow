...
const Modules = () => {
  ...
  const getModuleGradient = (title) => {
    ...
    if (
      ...
      titleLower.includes("fundamentos") ||
      titleLower.includes("foundation")
    ) {
      return "gradient-foundation";
    } else if (
      titleLower.includes("criação") ||
      titleLower.includes("creation") ||
      titleLower.includes("prática")
    ) {
      return "gradient-creation";
    } else if (
      titleLower.includes("estratégias") ||
      titleLower.includes("strategies") ||
      titleLower.includes("avançado")
    ) {
  ...
  return (
    <div className="h-screen bg-[#1a1a1a] flex">
      ...
      <div className="sidebar flex flex-col relative">
        ...
        <div
          className={`${showSearch ? "hidden" : "flex flex-col h-full"} ${
            showSidebarContent ? "sidebar-entering" : "opacity-0"
          }`}
        >
          {/* Logo CourseOS */}
          <div className="p-6 border-b border-[#333333]">
            <div className="flex items-center gap-3">
              <div className="flex flex-col items-center mb-2 w-42 h-auto [filter:drop-shadow(0_0_6px_rgba(255,255,255,0.2))]">
                <img src="./public/img/logo-gt.png" alt="Logo Geração Tech" />
              </div>
            </div>
          </div>
          ...
          <div className="p-4 flex-1 overflow-y-auto">
            <div className="section-header">Módulos</div>
            <div className="space-y-1">
              {modules.map((module, index) => (
                ...
                >
                  <div className="text-[#888888]">{getModuleIcon(index)}</div>
      ...
      {/* CONTEÚDO PRINCIPAL */}
      <div
        className={`flex-1 bg-[#1a1a1a] overflow-y-auto ${
          showMainContent ? "main-content-entering" : "opacity-0"
        }`}
      >
        {selectedModule ? (
          <div className="h-full">
            ...
            <div
              className={`header-gradient ${getModuleGradient(
            ...
            <div className="px-8 py-8">
              ...
              <div className="mb-8">
                ...
                <p className="text-[#888888]">{selectedModule.description}</p>
              </div>
